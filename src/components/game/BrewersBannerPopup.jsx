...
export default function BrewersBannerPopup({ entry, onDismiss, onAchievement }) {
  const [visible, setVisible] = useState(false);

  useEffect(() => {
    setVisible(true);
    const unlocked = trackBrewersBannerView(entry.id);
  ...
  const categoryColors = {
    bobblehead: 'from-blue-700 to-green-700',
    poster: 'from-green-800 to-blue-800',
    tradition: 'from-slate-600 to-green-700',
    historic: 'from-green-700 to-blue-700',
    inspiration: 'from-blue-600 to-green-600',
    community: 'from-green-700 to-blue-600',
    ballpark: 'from-blue-700 to-green-600',
    fans: 'from-green-600 to-blue-600',
  };
    ...
    <div className="fixed inset-0 z-50 flex items-end sm:items-center justify-center" onClick={onDismiss}>
      ...
      >
        ...
        <div className="bg-black/40 px-5 py-2.5 flex justify-between items-center border-t border-white/20">
          <span className="text-[9px] text-white/50 font-heading uppercase tracking-wider">🍺 Brewers Pride</span>
