            ...
            >
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center gap-2">
                    <span className="text-xs font-heading text-secondary bg-secondary/10 px-2 py-1 rounded">BETA</span>
                    <span className="text-xs font-heading text-secondary/80 group-hover:text-secondary transition-colors">Open Dashboard →</span>
                  </div>
                </div>
              </div>
            </button>
