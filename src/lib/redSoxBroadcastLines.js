...
// 40% fundamentals, 25% Fenway, 15% player analysis, 10% history, 8% crowd, 2% dry humor

const POOLS = {
  fundamentals: {
    weight: 40,
    lines: [
      // Ned Martin: smooth, intelligent, baseball-first
      "\"Nicely done.\"",
      "\"A solid piece of hitting.\"",
      "\"He stayed with that pitch.\"",
      "\"That's good baseball.\"",
      "\"He was fooled on that one.\"",
      "\"Excellent pitch — never had a chance.\"",
      "\"Caught looking.\"",
      "\"Deep to left — that ball is gone. A long home run.\"",
      "\"He got all of it.\"",
      ...
      "\"Good baserunning — he read that ball off the bat.\"",
      ...
      "\"He didn't try to do too much. Smart baseball.\"",
  ...
  fenway: {
    weight: 25,
    lines: [
      // Fenway Park: the Green Monster, the quirks, the character
  ...
  players: {
    weight: 15,
    lines: [
      // Player analysis — 1984 Red Sox stars
      "\"One of baseball's most feared hitters — Jim Rice. Tremendous power.\"",
      "\"Dangerous every time up. The pitcher knows he can't afford a mistake.\"",
      "\"Outstanding right fielder — Dwight Evans. Strong throwing arm, and he knows how to use it.\"",
      "\"Excellent all-around player. Evans does everything well.\"",
      "\"Wade Boggs rarely strikes out. It's remarkable how consistent he is.\"",
      "\"A hitting machine — Boggs studies the game like a professor.\"",
      "\"Consistently productive. You look up at the end of the year and he's hit .350 again.\"",
      "\"A student of hitting. Wade Boggs approaches every at-bat with a plan.\"",
  ...
  dryHumor: {
    weight: 2,
    lines: [
      // Dry New England understatement — not jokes, just perfectly timed understatement
