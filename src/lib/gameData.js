...
export const TEAMS = {
  tigers: {
    ...
    rotation: [
      { name: "Jack Morris", pos: "SP", throws: "R", stamina: 10, pitchSpeed: 7, offSpeed: 8, control: 6 },
      { name: "Dan Petry", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 6, offSpeed: 7, control: 7 },
      { name: "Milt Wilcox", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 5, offSpeed: 7, control: 6 },
      { name: "Juan Berenguer", pos: "SP", throws: "R", stamina: 6, pitchSpeed: 7, offSpeed: 6, control: 4 },
    ],
    bullpen: [
      { name: "Willie Hernandez", pos: "CL", throws: "L", stamina: 4, pitchSpeed: 7, offSpeed: 10, control: 9 },
      { name: "Aurelio Lopez", pos: "RP", throws: "R", stamina: 5, pitchSpeed: 6, offSpeed: 7, control: 7 },
      { name: "Doug Bair", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 6, offSpeed: 6, control: 5 },
    ],
  },
  ...
  padres: {
    ...
    rotation: [
      { name: "Eric Show", pos: "SP", throws: "R", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 8 },
      { name: "Ed Whitson", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 6, offSpeed: 8, control: 7 },
      { name: "Tim Lollar", pos: "SP", throws: "L", stamina: 6, pitchSpeed: 6, offSpeed: 6, control: 5 },
      { name: "Andy Hawkins", pos: "SP", throws: "R", stamina: 7, pitchSpeed: 5, offSpeed: 6, control: 6 },
    ],
    bullpen: [
      { name: "Goose Gossage", pos: "CL", throws: "R", stamina: 3, pitchSpeed: 9, offSpeed: 8, control: 7 },
      { name: "Craig Lefferts", pos: "RP", throws: "L", stamina: 4, pitchSpeed: 6, offSpeed: 7, control: 8 },
      { name: "Dave Dravecky", pos: "RP", throws: "L", stamina: 5, pitchSpeed: 5, offSpeed: 7, control: 8 },
    ],
  },
  ...
  cubs: {
    ...
    rotation: [
      { name: "Rick Sutcliffe", pos: "SP", throws: "R", stamina: 9, pitchSpeed: 8, offSpeed: 9, control: 8 },
      { name: "Steve Trout", pos: "SP", throws: "L", stamina: 7, pitchSpeed: 6, offSpeed: 8, control: 6 },
      { name: "Dennis Eckersley", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 7, offSpeed: 7, control: 9 },
      { name: "Scott Sanderson", pos: "SP", throws: "R", stamina: 7, pitchSpeed: 7, offSpeed: 6, control: 7 },
    ],
    bullpen: [
      { name: "Lee Smith", pos: "CL", throws: "R", stamina: 4, pitchSpeed: 10, offSpeed: 7, control: 6 },
      { name: "Tim Stoddard", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 7, offSpeed: 5, control: 5 },
      { name: "George Frazier", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 5, offSpeed: 6, control: 6 },
    ],
  },
  ...
  mets: {
    ...
    rotation: [
      { name: "Dwight Gooden", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 10, offSpeed: 9, control: 7 },
      { name: "Ron Darling", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 7, offSpeed: 7, control: 6 },
      { name: "Walt Terrell", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 6, offSpeed: 6, control: 7 },
      { name: "Bruce Berenyi", pos: "SP", throws: "R", stamina: 7, pitchSpeed: 7, offSpeed: 5, control: 4 },
    ],
    bullpen: [
      { name: "Jesse Orosco", pos: "CL", throws: "L", stamina: 4, pitchSpeed: 7, offSpeed: 8, control: 7 },
      { name: "Doug Sisk", pos: "RP", throws: "R", stamina: 5, pitchSpeed: 5, offSpeed: 7, control: 5 },
      { name: "Brent Gaff", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 6, offSpeed: 5, control: 5 },
    ],
  },
  ...
  redsox: {
    ...
    rotation: [
      { name: "Bruce Hurst", pos: "SP", throws: "L", stamina: 8, pitchSpeed: 7, offSpeed: 8, control: 7 },
      { name: "Oil Can Boyd", pos: "SP", throws: "R", stamina: 7, pitchSpeed: 7, offSpeed: 7, control: 7 },
      { name: "Bob Ojeda", pos: "SP", throws: "L", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 6 },
      { name: "Al Nipper", pos: "SP", throws: "R", stamina: 7, pitchSpeed: 5, offSpeed: 6, control: 6 },
    ],
    bullpen: [
      { name: "Bob Stanley", pos: "CL", throws: "R", stamina: 5, pitchSpeed: 5, offSpeed: 8, control: 8 },
      { name: "Mark Clear", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 8, offSpeed: 5, control: 4 },
      { name: "John Henry Johnson", pos: "RP", throws: "L", stamina: 4, pitchSpeed: 6, offSpeed: 5, control: 5 },
    ],
  },
  ...
  yankees: {
    ...
    bullpen: [
      { name: "Dave Righetti", pos: "CL", throws: "L", stamina: 4, pitchSpeed: 9, offSpeed: 7, control: 7 },
      { name: "Jay Howell", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 7, offSpeed: 6, control: 6 },
      { name: "Mike Armstrong", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 6, offSpeed: 5, control: 5 },
    ],
  },
  ...
  orioles: {
    ...
    rotation: [
      { name: "Mike Boddicker", pos: "SP", throws: "R", stamina: 8, pitchSpeed: 6, offSpeed: 9, control: 7 },
      { name: "Scott McGregor", pos: "SP", throws: "L", stamina: 8, pitchSpeed: 5, offSpeed: 8, control: 9 },
      { name: "Storm Davis", pos: "SP", throws: "R", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 7 },
      { name: "Mike Flanagan", pos: "SP", throws: "L", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 6 },
    ],
    bullpen: [
      { name: "Tippy Martinez", pos: "CL", throws: "L", stamina: 4, pitchSpeed: 7, offSpeed: 8, control: 6 },
      { name: "Sammy Stewart", pos: "RP", throws: "R", stamina: 5, pitchSpeed: 6, offSpeed: 6, control: 6 },
      { name: "Tom Underwood", pos: "RP", throws: "L", stamina: 4, pitchSpeed: 6, offSpeed: 6, control: 5 },
    ],
  },
  ...
  dodgers: {
    ...
    bullpen: [
      { name: "Ken Howell", pos: "CL", throws: "R", stamina: 4, pitchSpeed: 8, offSpeed: 6, control: 5 },
      { name: "Pat Zachry", pos: "RP", throws: "R", stamina: 4, pitchSpeed: 5, offSpeed: 6, control: 5 },
      { name: "Carlos Diaz", pos: "RP", throws: "L", stamina: 3, pitchSpeed: 5, offSpeed: 6, control: 6 },
    ],
  },
};
