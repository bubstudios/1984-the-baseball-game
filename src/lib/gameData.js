...
export const TEAMS = {
  ...
  bluejays: {
    ...
    lineup: [
      { name: "Damaso Garcia", pos: "2B", bats: "R", contact: 7, power: 3, bunting: 6, speed: 7, defense: 7, arm: 6,
        splits: { vsLHP: { ab: 148, ba: .268, hr: 2 }, vsRHP: { ab: 421, ba: .299, hr: 3 } } },
      { name: "Lloyd Moseby", pos: "CF", bats: "L", contact: 6, power: 6, bunting: 5, speed: 8, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 151, ba: .237, hr: 6 }, vsRHP: { ab: 441, ba: .283, hr: 12 } } },
      { name: "Jesse Barfield", pos: "RF", bats: "R", contact: 6, power: 7, bunting: 3, speed: 5, defense: 9, arm: 10,
        splits: { vsLHP: { ab: 143, ba: .252, hr: 8 }, vsRHP: { ab: 357, ba: .281, hr: 14 } } },
      { name: "Willie Upshaw", pos: "1B", bats: "L", contact: 7, power: 6, bunting: 3, speed: 4, defense: 6, arm: 5,
        splits: { vsLHP: { ab: 71, ba: .211, hr: 2 }, vsRHP: { ab: 499, ba: .295, hr: 17 } } },
      { name: "Rance Mulliniks", pos: "3B", bats: "L", contact: 7, power: 5, bunting: 4, speed: 3, defense: 6, arm: 6,
        splits: { vsLHP: { ab: 44, ba: .182, hr: 0 }, vsRHP: { ab: 339, ba: .324, hr: 12 } } },
      { name: "George Bell", pos: "LF", bats: "R", contact: 7, power: 7, bunting: 2, speed: 5, defense: 5, arm: 7,
        splits: { vsLHP: { ab: 146, ba: .247, hr: 6 }, vsRHP: { ab: 459, ba: .292, hr: 20 } } },
      { name: "Ernie Whitt", pos: "C", bats: "L", contact: 6, power: 6, bunting: 3, speed: 2, defense: 6, arm: 7,
        splits: { vsLHP: { ab: 55, ba: .218, hr: 2 }, vsRHP: { ab: 260, ba: .271, hr: 13 } } },
      { name: "Tony Fernandez", pos: "SS", bats: "S", contact: 7, power: 3, bunting: 5, speed: 6, defense: 9, arm: 8,
        splits: { vsLHP: { ab: 149, ba: .282, hr: 3 }, vsRHP: { ab: 384, ba: .267, hr: 5 } } },
      { name: "Cliff Johnson", pos: "DH", bats: "R", contact: 5, power: 7, bunting: 2, speed: 2, defense: 0, arm: 0,
        splits: estSplits(.304, 16, 254, 76, "R") },
    ],
    bench: [
      { name: "Garth Iorg", pos: "2B/3B", bats: "R", contact: 5, power: 3, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.261, 6, 228, 68, "R") },
      { name: "Buck Martinez", pos: "C", bats: "R", contact: 4, power: 3, bunting: 3, speed: 2, defense: 6, arm: 7,
        splits: estSplits(.218, 4, 139, 42, "R") },
      { name: "Dave Collins", pos: "OF", bats: "S", contact: 6, power: 2, bunting: 7, speed: 7, defense: 6, arm: 5,
        splits: estSplits(.272, 2, 294, 84, "S") },
      { name: "Mitch Webster", pos: "OF", bats: "S", contact: 5, power: 2, bunting: 5, speed: 6, defense: 6, arm: 5,
        splits: estSplits(.246, 2, 101, 30, "S") },
      { name: "Jorge Orta", pos: "DH", bats: "L", contact: 5, power: 4, bunting: 3, speed: 3, defense: 4, arm: 4,
        splits: estSplits(.261, 6, 234, 68, "L") },
    ],
    rotation: [
      ...
      { name: "Jimmy Key", pos: "SP", throws: "L", bats: "R", stamina: 7, pitchSpeed: 6, offSpeed: 8, control: 8, contact: 3, power: 1, bunting: 4, speed: 2 },
    ],
    bullpen: [
      { name: "Dennis Lamp", pos: "CL", throws: "R", bats: "R", stamina: 5, pitchSpeed: 6, offSpeed: 7, control: 7, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Jim Acker", pos: "RP", throws: "R", bats: "R", stamina: 5, pitchSpeed: 6, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Roy Lee Jackson", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 7, offSpeed: 5, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Joey McLaughlin", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 5, offSpeed: 6, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
  ...
  indians: {
    ...
    lineup: [
      { name: "Julio Franco", pos: "SS", bats: "R", contact: 7, power: 4, bunting: 5, speed: 6, defense: 5, arm: 6,
        splits: { vsLHP: { ab: 163, ba: .294, hr: 4 }, vsRHP: { ab: 395, ba: .290, hr: 4 } } },
      { name: "Mel Hall", pos: "LF", bats: "L", contact: 7, power: 5, bunting: 4, speed: 5, defense: 5, arm: 6,
        splits: { vsLHP: { ab: 78, ba: .218, hr: 1 }, vsRHP: { ab: 397, ba: .282, hr: 17 } } },
      { name: "Andre Thornton", pos: "1B", bats: "R", contact: 6, power: 8, bunting: 2, speed: 3, defense: 6, arm: 5,
        splits: { vsLHP: { ab: 183, ba: .268, hr: 12 }, vsRHP: { ab: 393, ba: .269, hr: 21 } } },
      { name: "Carmelo Castillo", pos: "RF", bats: "R", contact: 6, power: 5, bunting: 3, speed: 5, defense: 5, arm: 6,
        splits: estSplits(.249, 10, 299, 88, "R") },
      { name: "Brett Butler", pos: "CF", bats: "L", contact: 7, power: 2, bunting: 8, speed: 9, defense: 8, arm: 6,
        splits: { vsLHP: { ab: 116, ba: .259, hr: 0 }, vsRHP: { ab: 447, ba: .278, hr: 3 } } },
      { name: "Pat Tabler", pos: "3B", bats: "R", contact: 7, power: 4, bunting: 4, speed: 3, defense: 5, arm: 6,
        splits: { vsLHP: { ab: 157, ba: .307, hr: 2 }, vsRHP: { ab: 416, ba: .285, hr: 8 } } },
      { name: "Tony Bernazard", pos: "2B", bats: "S", contact: 6, power: 4, bunting: 5, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.221, 5, 314, 90, "S") },
      { name: "Chris Bando", pos: "C", bats: "S", contact: 5, power: 3, bunting: 4, speed: 3, defense: 6, arm: 6,
        splits: estSplits(.238, 5, 282, 84, "S") },
      { name: "Joe Carter", pos: "DH", bats: "R", contact: 6, power: 6, bunting: 3, speed: 6, defense: 6, arm: 7,
        splits: estSplits(.275, 13, 244, 74, "R") },
    ],
    bench: [
      { name: "George Vukovich", pos: "OF", bats: "L", contact: 6, power: 3, bunting: 4, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.254, 5, 184, 54, "L") },
      { name: "Jerry Willard", pos: "C", bats: "L", contact: 5, power: 4, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: estSplits(.224, 6, 127, 38, "L") },
      { name: "Mike Fischlin", pos: "SS", bats: "R", contact: 4, power: 1, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.207, 0, 116, 34, "R") },
      { name: "Mike Hargrove", pos: "1B", bats: "L", contact: 6, power: 2, bunting: 5, speed: 2, defense: 5, arm: 4,
        splits: estSplits(.269, 3, 241, 72, "L") },
      { name: "Brook Jacoby", pos: "3B", bats: "R", contact: 5, power: 4, bunting: 4, speed: 3, defense: 5, arm: 6,
        splits: estSplits(.252, 7, 299, 90, "R") },
    ],
    rotation: [
      ...
      { name: "Roy Smith", pos: "SP", throws: "R", bats: "R", stamina: 6, pitchSpeed: 5, offSpeed: 5, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
    bullpen: [
      ...
      { name: "Don Schulze", pos: "RP", throws: "R", bats: "R", stamina: 5, pitchSpeed: 6, offSpeed: 5, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
  ...
  brewers: {
    ...
    lineup: [
      { name: "Robin Yount", pos: "CF", bats: "R", contact: 8, power: 6, bunting: 4, speed: 6, defense: 8, arm: 8,
        splits: { vsLHP: { ab: 168, ba: .286, hr: 5 }, vsRHP: { ab: 411, ba: .298, hr: 11 } } },
      { name: "Cecil Cooper", pos: "1B", bats: "L", contact: 8, power: 6, bunting: 3, speed: 4, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 147, ba: .225, hr: 5 }, vsRHP: { ab: 459, ba: .282, hr: 16 } } },
      { name: "Ted Simmons", pos: "C", bats: "S", contact: 6, power: 6, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: { vsLHP: { ab: 128, ba: .219, hr: 4 }, vsRHP: { ab: 361, ba: .264, hr: 6 } } },
      { name: "Ben Oglivie", pos: "LF", bats: "L", contact: 6, power: 7, bunting: 3, speed: 4, defense: 5, arm: 6,
        splits: estSplits(.262, 12, 404, 118, "L") },
      { name: "Jim Gantner", pos: "2B", bats: "L", contact: 7, power: 3, bunting: 5, speed: 5, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 98, ba: .245, hr: 0 }, vsRHP: { ab: 415, ba: .286, hr: 3 } } },
      { name: "Don Money", pos: "3B", bats: "R", contact: 5, power: 5, bunting: 4, speed: 3, defense: 6, arm: 6,
        splits: estSplits(.228, 9, 241, 72, "R") },
      { name: "Rick Manning", pos: "RF", bats: "L", contact: 6, power: 3, bunting: 5, speed: 6, defense: 7, arm: 6,
        splits: estSplits(.243, 4, 236, 68, "L") },
      { name: "Ed Romero", pos: "SS", bats: "R", contact: 5, power: 2, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.241, 2, 179, 54, "R") },
      { name: "Mark Brouhard", pos: "DH", bats: "R", contact: 5, power: 4, bunting: 3, speed: 3, defense: 0, arm: 0,
        splits: estSplits(.249, 9, 194, 58, "R") },
    ],
    bench: [
      { name: "Randy Ready", pos: "2B/3B", bats: "R", contact: 5, power: 3, bunting: 5, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.234, 3, 161, 48, "R") },
      { name: "Dion James", pos: "OF", bats: "L", contact: 6, power: 2, bunting: 5, speed: 5, defense: 5, arm: 5,
        splits: estSplits(.251, 1, 108, 32, "L") },
      { name: "Charlie Moore", pos: "C/OF", bats: "R", contact: 5, power: 2, bunting: 4, speed: 3, defense: 5, arm: 6,
        splits: estSplits(.239, 2, 211, 62, "R") },
      { name: "Bob Clark", pos: "C", bats: "R", contact: 4, power: 2, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: estSplits(.218, 2, 96, 28, "R") },
      { name: "Ray Fosse", pos: "OF", bats: "R", contact: 5, power: 3, bunting: 4, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.241, 3, 118, 34, "R") },
    ],
    rotation: [
      { name: "Moose Haas", pos: "SP", throws: "R", bats: "R", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 7, contact: 3, power: 1, bunting: 4, speed: 2 },
      { name: "Pete Vuckovich", pos: "SP", throws: "R", bats: "R", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 6, contact: 3, power: 2, bunting: 5, speed: 2 },
      { name: "Chuck Porter", pos: "SP", throws: "R", bats: "R", stamina: 7, pitchSpeed: 5, offSpeed: 6, control: 6, contact: 3, power: 1, bunting: 4, speed: 2 },
      { name: "Bob Gibson", pos: "SP", throws: "R", bats: "R", stamina: 6, pitchSpeed: 6, offSpeed: 6, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
    bullpen: [
      ...
      { name: "Bob McClure", pos: "RP", throws: "L", bats: "L", stamina: 4, pitchSpeed: 5, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Randy Lerch", pos: "RP", throws: "L", bats: "L", stamina: 4, pitchSpeed: 5, offSpeed: 5, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
  ...
  twins: {
    ...
    lineup: [
      { name: "Kent Hrbek", pos: "1B", bats: "L", contact: 7, power: 8, bunting: 2, speed: 3, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 138, ba: .217, hr: 7 }, vsRHP: { ab: 421, ba: .320, hr: 20 } } },
      { name: "Gary Gaetti", pos: "3B", bats: "R", contact: 6, power: 7, bunting: 3, speed: 4, defense: 8, arm: 8,
        splits: { vsLHP: { ab: 193, ba: .278, hr: 7 }, vsRHP: { ab: 395, ba: .267, hr: 18 } } },
      { name: "Tom Brunansky", pos: "RF", bats: "R", contact: 6, power: 8, bunting: 2, speed: 5, defense: 7, arm: 8,
        splits: { vsLHP: { ab: 188, ba: .271, hr: 9 }, vsRHP: { ab: 379, ba: .264, hr: 23 } } },
      { name: "Mickey Hatcher", pos: "LF", bats: "R", contact: 7, power: 3, bunting: 5, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.281, 5, 423, 128, "R") },
      { name: "Kirby Puckett", pos: "CF", bats: "R", contact: 7, power: 4, bunting: 4, speed: 6, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 149, ba: .296, hr: 0 }, vsRHP: { ab: 408, ba: .296, hr: 0 } } },
      { name: "Dave Engle", pos: "C", bats: "R", contact: 5, power: 3, bunting: 4, speed: 3, defense: 5, arm: 6,
        splits: estSplits(.250, 4, 268, 80, "R") },
      { name: "Tim Teufel", pos: "2B", bats: "R", contact: 6, power: 5, bunting: 4, speed: 4, defense: 5, arm: 5,
        splits: { vsLHP: { ab: 158, ba: .285, hr: 8 }, vsRHP: { ab: 349, ba: .258, hr: 6 } } },
      { name: "Houston Jimenez", pos: "SS", bats: "R", contact: 4, power: 2, bunting: 5, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.215, 2, 198, 58, "R") },
      { name: "Ken Landreaux", pos: "DH", bats: "L", contact: 6, power: 4, bunting: 4, speed: 5, defense: 0, arm: 0,
        splits: estSplits(.262, 12, 351, 104, "L") },
    ],
    bench: [
      { name: "Randy Bush", pos: "OF/DH", bats: "L", contact: 6, power: 4, bunting: 3, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.264, 11, 311, 92, "L") },
      { name: "Lenny Faedo", pos: "SS", bats: "R", contact: 5, power: 2, bunting: 5, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.228, 2, 142, 42, "R") },
      { name: "Tim Laudner", pos: "C", bats: "R", contact: 4, power: 5, bunting: 2, speed: 2, defense: 5, arm: 7,
        splits: estSplits(.219, 10, 194, 58, "R") },
      { name: "Jim Eisenreich", pos: "OF", bats: "L", contact: 6, power: 2, bunting: 5, speed: 6, defense: 6, arm: 5,
        splits: estSplits(.257, 2, 12, 4, "L") },
      { name: "Ron Washington", pos: "SS/2B", bats: "R", contact: 5, power: 2, bunting: 5, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.239, 3, 141, 42, "R") },
    ],
    rotation: [
    ...
    bullpen: [
      ...
      { name: "Brad Havens", pos: "RP", throws: "L", bats: "L", stamina: 4, pitchSpeed: 5, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
  ...
  athletics: {
    ...
    lineup: [
      { name: "Rickey Henderson", pos: "LF", bats: "R", contact: 7, power: 6, bunting: 6, speed: 10, defense: 8, arm: 7,
        splits: { vsLHP: { ab: 143, ba: .308, hr: 8 }, vsRHP: { ab: 400, ba: .285, hr: 8 } } },
      { name: "Dave Kingman", pos: "DH", bats: "R", contact: 4, power: 10, bunting: 1, speed: 2, defense: 0, arm: 0,
        splits: { vsLHP: { ab: 168, ba: .244, hr: 10 }, vsRHP: { ab: 398, ba: .253, hr: 25 } } },
      { name: "Carney Lansford", pos: "3B", bats: "R", contact: 8, power: 5, bunting: 4, speed: 5, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 163, ba: .300, hr: 4 }, vsRHP: { ab: 434, ba: .300, hr: 10 } } },
      { name: "Mike Davis", pos: "RF", bats: "L", contact: 6, power: 5, bunting: 4, speed: 6, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 78, ba: .295, hr: 4 }, vsRHP: { ab: 346, ba: .235, hr: 5 } } },
      { name: "Dwayne Murphy", pos: "CF", bats: "L", contact: 5, power: 6, bunting: 5, speed: 6, defense: 9, arm: 7,
        splits: { vsLHP: { ab: 53, ba: .189, hr: 2 }, vsRHP: { ab: 337, ba: .260, hr: 11 } } },
      { name: "Bruce Bochte", pos: "1B", bats: "L", contact: 7, power: 4, bunting: 4, speed: 3, defense: 6, arm: 5,
        splits: estSplits(.276, 6, 361, 106, "L") },
      { name: "Mike Heath", pos: "C", bats: "R", contact: 5, power: 4, bunting: 3, speed: 3, defense: 6, arm: 7,
        splits: estSplits(.248, 8, 259, 78, "R") },
      { name: "Tony Phillips", pos: "2B", bats: "S", contact: 5, power: 3, bunting: 6, speed: 6, defense: 6, arm: 6,
        splits: estSplits(.266, 4, 368, 108, "S") },
      { name: "Alfredo Griffin", pos: "SS", bats: "S", contact: 5, power: 2, bunting: 6, speed: 5, defense: 8, arm: 7,
        splits: estSplits(.241, 4, 419, 124, "S") },
    ],
    bench: [
      { name: "Dave Lopes", pos: "2B/OF", bats: "R", contact: 5, power: 4, bunting: 4, speed: 5, defense: 5, arm: 5,
        splits: estSplits(.224, 7, 159, 48, "R") },
      { name: "Jim Essian", pos: "C", bats: "R", contact: 4, power: 3, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: estSplits(.219, 4, 128, 38, "R") },
      { name: "Donnie Hill", pos: "SS/2B", bats: "S", contact: 5, power: 2, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.243, 2, 153, 46, "S") },
      { name: "Steve Henderson", pos: "OF", bats: "R", contact: 6, power: 3, bunting: 4, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.259, 4, 141, 42, "R") },
      { name: "Kelvin Moore", pos: "1B", bats: "L", contact: 4, power: 4, bunting: 3, speed: 2, defense: 5, arm: 4,
        splits: estSplits(.225, 6, 151, 44, "L") },
    ],
    rotation: [
      { name: "Mike Warren", pos: "SP", throws: "R", bats: "R", stamina: 7, pitchSpeed: 6, offSpeed: 6, control: 7, contact: 2, power: 1, bunting: 3, speed: 2 },
      ...
      { name: "Tim Conroy", pos: "SP", throws: "L", bats: "L", stamina: 6, pitchSpeed: 7, offSpeed: 5, control: 4, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
    bullpen: [
      { name: "Jay Howell", pos: "CL", throws: "R", bats: "R", stamina: 4, pitchSpeed: 8, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Dave Beard", pos: "RP", throws: "L", bats: "L", stamina: 4, pitchSpeed: 5, offSpeed: 6, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Steve Baker", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 5, offSpeed: 5, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Tom Burgmeier", pos: "RP", throws: "L", bats: "L", stamina: 3, pitchSpeed: 5, offSpeed: 7, control: 7, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
  ...
  angels: {
    ...
    lineup: [
      { name: "Rod Carew", pos: "1B", bats: "L", contact: 9, power: 2, bunting: 8, speed: 4, defense: 6, arm: 4,
        splits: { vsLHP: { ab: 115, ba: .261, hr: 0 }, vsRHP: { ab: 381, ba: .295, hr: 3 } } },
      { name: "Reggie Jackson", pos: "DH", bats: "L", contact: 5, power: 9, bunting: 1, speed: 3, defense: 0, arm: 0,
        splits: { vsLHP: { ab: 168, ba: .220, hr: 11 }, vsRHP: { ab: 362, ba: .252, hr: 14 } } },
      { name: "Bob Boone", pos: "C", bats: "R", contact: 6, power: 3, bunting: 5, speed: 3, defense: 9, arm: 8,
        splits: { vsLHP: { ab: 143, ba: .238, hr: 3 }, vsRHP: { ab: 367, ba: .202, hr: 1 } } },
      { name: "Doug DeCinces", pos: "3B", bats: "R", contact: 6, power: 6, bunting: 3, speed: 3, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 168, ba: .289, hr: 8 }, vsRHP: { ab: 349, ba: .265, hr: 12 } } },
      { name: "Brian Downing", pos: "LF", bats: "R", contact: 7, power: 5, bunting: 3, speed: 3, defense: 6, arm: 6,
        splits: { vsLHP: { ab: 148, ba: .278, hr: 6 }, vsRHP: { ab: 368, ba: .237, hr: 17 } } },
      { name: "Gary Pettis", pos: "CF", bats: "S", contact: 5, power: 2, bunting: 7, speed: 10, defense: 9, arm: 7,
        splits: { vsLHP: { ab: 129, ba: .291, hr: 2 }, vsRHP: { ab: 316, ba: .232, hr: 0 } } },
      { name: "Ruppert Jones", pos: "RF", bats: "L", contact: 5, power: 5, bunting: 4, speed: 5, defense: 6, arm: 6,
        splits: estSplits(.284, 12, 345, 102, "L") },
      { name: "Bobby Grich", pos: "2B", bats: "R", contact: 6, power: 5, bunting: 3, speed: 3, defense: 8, arm: 6,
        splits: estSplits(.256, 18, 431, 128, "R") },
      { name: "Dick Schofield", pos: "SS", bats: "R", contact: 5, power: 4, bunting: 4, speed: 6, defense: 7, arm: 7,
        splits: estSplits(.193, 5, 258, 76, "R") },
    ],
    bench: [
      { name: "Juan Beniquez", pos: "OF", bats: "R", contact: 6, power: 3, bunting: 5, speed: 5, defense: 5, arm: 5,
        splits: estSplits(.336, 6, 281, 84, "R") },
      { name: "Ron Jackson", pos: "1B/3B", bats: "R", contact: 5, power: 4, bunting: 3, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.228, 7, 214, 64, "R") },
      { name: "Fred Lynn", pos: "CF", bats: "L", contact: 7, power: 6, bunting: 3, speed: 5, defense: 7, arm: 7,
        splits: estSplits(.271, 23, 511, 152, "L") },
      { name: "Ellis Valentine", pos: "OF", bats: "R", contact: 5, power: 4, bunting: 3, speed: 4, defense: 6, arm: 9,
        splits: estSplits(.239, 5, 181, 54, "R") },
      { name: "Rob Wilfong", pos: "2B", bats: "L", contact: 5, power: 3, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.259, 5, 234, 70, "L") },
    ],
    rotation: [
    ...
    bullpen: [
      ...
      { name: "Luis Sanchez", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 6, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Doug Corbett", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 5, offSpeed: 7, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Jerry Narron", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 5, offSpeed: 5, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
  ...
  whitesox: {
    ...
    lineup: [
      { name: "Carlton Fisk", pos: "C", bats: "R", contact: 6, power: 8, bunting: 2, speed: 3, defense: 7, arm: 8,
        splits: { vsLHP: { ab: 168, ba: .232, hr: 10 }, vsRHP: { ab: 391, ba: .235, hr: 11 } } },
      { name: "Harold Baines", pos: "RF", bats: "L", contact: 8, power: 8, bunting: 2, speed: 4, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 145, ba: .262, hr: 8 }, vsRHP: { ab: 424, ba: .304, hr: 21 } } },
      { name: "Ron Kittle", pos: "DH", bats: "R", contact: 4, power: 9, bunting: 1, speed: 2, defense: 0, arm: 0,
        splits: { vsLHP: { ab: 133, ba: .218, hr: 5 }, vsRHP: { ab: 333, ba: .219, hr: 27 } } },
      { name: "Greg Luzinski", pos: "LF", bats: "R", contact: 5, power: 7, bunting: 2, speed: 2, defense: 4, arm: 5,
        splits: estSplits(.238, 13, 325, 98, "R") },
      { name: "Tom Paciorek", pos: "1B", bats: "R", contact: 7, power: 5, bunting: 3, speed: 3, defense: 6, arm: 5,
        splits: estSplits(.281, 8, 373, 112, "R") },
      { name: "Rudy Law", pos: "CF", bats: "L", contact: 6, power: 2, bunting: 6, speed: 9, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 75, ba: .280, hr: 0 }, vsRHP: { ab: 462, ba: .253, hr: 3 } } },
      { name: "Julio Cruz", pos: "2B", bats: "S", contact: 5, power: 2, bunting: 7, speed: 8, defense: 7, arm: 5,
        splits: estSplits(.222, 1, 291, 88, "S") },
      { name: "Scott Fletcher", pos: "SS", bats: "R", contact: 5, power: 2, bunting: 6, speed: 5, defense: 7, arm: 6,
        splits: { vsLHP: { ab: 128, ba: .250, hr: 0 }, vsRHP: { ab: 386, ba: .263, hr: 3 } } },
      { name: "Vance Law", pos: "3B", bats: "R", contact: 6, power: 3, bunting: 4, speed: 4, defense: 6, arm: 6,
        splits: estSplits(.252, 7, 381, 114, "R") },
    ],
    bench: [
      { name: "Jerry Hairston", pos: "OF", bats: "S", contact: 5, power: 2, bunting: 5, speed: 5, defense: 5, arm: 5,
        splits: estSplits(.267, 2, 182, 54, "S") },
      { name: "Marc Hill", pos: "C", bats: "R", contact: 4, power: 3, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: estSplits(.219, 4, 128, 38, "R") },
      { name: "Randy Hogcroft", pos: "3B", bats: "R", contact: 4, power: 2, bunting: 4, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.214, 1, 96, 28, "R") },
      { name: "Luis Salazar", pos: "OF/3B", bats: "R", contact: 5, power: 3, bunting: 5, speed: 6, defense: 5, arm: 6,
        splits: estSplits(.241, 5, 241, 72, "R") },
      { name: "Joel Skinner", pos: "C", bats: "R", contact: 4, power: 2, bunting: 3, speed: 2, defense: 5, arm: 7,
        splits: estSplits(.194, 2, 96, 28, "R") },
    ],
    rotation: [
      ...
      { name: "Britt Burns", pos: "SP", throws: "L", bats: "L", stamina: 7, pitchSpeed: 8, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 4, speed: 2 },
    ],
    bullpen: [
      { name: "Bob James", pos: "CL", throws: "R", bats: "R", stamina: 4, pitchSpeed: 8, offSpeed: 5, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
      ...
      { name: "Dennis Lamp", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 6, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
  ...
  mariners: {
    ...
    stadium: "Kingdome",
    lineup: [
      { name: "Alvin Davis", pos: "1B", bats: "L", contact: 7, power: 7, bunting: 3, speed: 3, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 124, ba: .274, hr: 4 }, vsRHP: { ab: 443, ba: .289, hr: 23 } } },
      { name: "Phil Bradley", pos: "CF", bats: "R", contact: 7, power: 4, bunting: 5, speed: 7, defense: 6, arm: 7,
        splits: { vsLHP: { ab: 128, ba: .336, hr: 5 }, vsRHP: { ab: 394, ba: .284, hr: 9 } } },
      { name: "Jack Perconte", pos: "2B", bats: "L", contact: 6, power: 2, bunting: 6, speed: 6, defense: 7, arm: 5,
        splits: estSplits(.294, 1, 456, 136, "L") },
      { name: "Gorman Thomas", pos: "DH", bats: "R", contact: 4, power: 9, bunting: 1, speed: 3, defense: 0, arm: 0,
        splits: estSplits(.215, 32, 489, 146, "R") },
      { name: "Al Cowens", pos: "RF", bats: "R", contact: 6, power: 4, bunting: 4, speed: 5, defense: 7, arm: 7,
        splits: estSplits(.268, 6, 311, 94, "R") },
      { name: "Dave Henderson", pos: "LF", bats: "R", contact: 6, power: 5, bunting: 4, speed: 5, defense: 7, arm: 8,
        splits: estSplits(.280, 14, 350, 104, "R") },
      { name: "Bob Kearney", pos: "C", bats: "R", contact: 5, power: 4, bunting: 3, speed: 2, defense: 6, arm: 6,
        splits: estSplits(.211, 8, 261, 78, "R") },
      { name: "Spike Owen", pos: "SS", bats: "S", contact: 5, power: 2, bunting: 6, speed: 5, defense: 7, arm: 6,
        splits: estSplits(.245, 3, 419, 124, "S") },
      { name: "Jim Presley", pos: "3B", bats: "R", contact: 5, power: 7, bunting: 3, speed: 3, defense: 5, arm: 7,
        splits: estSplits(.227, 10, 251, 74, "R") },
    ],
    bench: [
      { name: "Steve Henderson", pos: "OF", bats: "R", contact: 6, power: 3, bunting: 4, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.259, 4, 141, 42, "R") },
      { name: "Orlando Mercado", pos: "C", bats: "R", contact: 4, power: 2, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: estSplits(.209, 1, 86, 26, "R") },
      { name: "Domingo Ramos", pos: "SS/2B", bats: "R", contact: 4, power: 1, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.218, 1, 116, 34, "R") },
      { name: "Ivan Calderon", pos: "OF", bats: "R", contact: 5, power: 4, bunting: 3, speed: 5, defense: 5, arm: 6,
        splits: estSplits(.222, 5, 68, 20, "R") },
      { name: "Ricky Nelson", pos: "OF", bats: "L", contact: 5, power: 2, bunting: 5, speed: 5, defense: 5, arm: 5,
        splits: estSplits(.252, 2, 116, 34, "L") },
    ],
    rotation: [
      ...
      { name: "Dave Beard", pos: "SP", throws: "L", bats: "L", stamina: 7, pitchSpeed: 5, offSpeed: 6, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
    ...
    bullpen: [
      { name: "Ed Vande Berg", pos: "CL", throws: "L", bats: "L", stamina: 4, pitchSpeed: 5, offSpeed: 7, control: 7, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Karl Best", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 6, offSpeed: 6, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Matt Young", pos: "RP", throws: "L", bats: "L", stamina: 5, pitchSpeed: 7, offSpeed: 5, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
  ...
  rangers: {
    ...
    lineup: [
      { name: "Larry Parrish", pos: "3B", bats: "R", contact: 6, power: 8, bunting: 2, speed: 3, defense: 5, arm: 7,
        splits: { vsLHP: { ab: 171, ba: .243, hr: 8 }, vsRHP: { ab: 403, ba: .285, hr: 14 } } },
      { name: "Gary Ward", pos: "CF", bats: "R", contact: 7, power: 6, bunting: 3, speed: 5, defense: 6, arm: 7,
        splits: { vsLHP: { ab: 169, ba: .307, hr: 5 }, vsRHP: { ab: 394, ba: .279, hr: 16 } } },
      { name: "Pete O'Brien", pos: "1B", bats: "L", contact: 7, power: 6, bunting: 3, speed: 3, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 131, ba: .237, hr: 4 }, vsRHP: { ab: 388, ba: .302, hr: 14 } } },
      { name: "Buddy Bell", pos: "DH", bats: "R", contact: 7, power: 5, bunting: 4, speed: 3, defense: 9, arm: 8,
        splits: { vsLHP: { ab: 163, ba: .303, hr: 5 }, vsRHP: { ab: 490, ba: .325, hr: 6 } } },
      { name: "Bobby Jones", pos: "RF", bats: "L", contact: 6, power: 4, bunting: 4, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.261, 9, 366, 108, "L") },
      { name: "Tommy Dunbar", pos: "LF", bats: "L", contact: 5, power: 4, bunting: 4, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.252, 6, 219, 64, "L") },
      { name: "Donnie Scott", pos: "C", bats: "S", contact: 5, power: 3, bunting: 4, speed: 3, defense: 6, arm: 6,
        splits: estSplits(.229, 4, 183, 54, "S") },
      { name: "Curtis Wilkerson", pos: "SS", bats: "S", contact: 5, power: 2, bunting: 6, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.236, 1, 329, 98, "S") },
      { name: "Wayne Tolleson", pos: "2B", bats: "S", contact: 5, power: 2, bunting: 6, speed: 6, defense: 6, arm: 5,
        splits: estSplits(.213, 1, 306, 92, "S") },
    ],
    bench: [
      { name: "Dave Hostetler", pos: "1B", bats: "R", contact: 4, power: 5, bunting: 2, speed: 2, defense: 5, arm: 4,
        splits: estSplits(.209, 8, 201, 60, "R") },
      { name: "Ned Yost", pos: "C", bats: "R", contact: 4, power: 2, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: estSplits(.182, 2, 68, 20, "R") },
      { name: "Mickey Rivers", pos: "OF", bats: "L", contact: 6, power: 2, bunting: 6, speed: 8, defense: 6, arm: 5,
        splits: estSplits(.279, 3, 184, 54, "L") },
      { name: "Jeff Kunkel", pos: "SS", bats: "R", contact: 4, power: 2, bunting: 5, speed: 5, defense: 6, arm: 6,
        splits: estSplits(.204, 2, 116, 34, "R") },
      { name: "George Wright", pos: "OF", bats: "R", contact: 5, power: 3, bunting: 5, speed: 7, defense: 6, arm: 6,
        splits: estSplits(.246, 5, 311, 94, "R") },
    ],
    rotation: [
    ...
    bullpen: [
      { name: "Dave Stewart", pos: "CL", throws: "R", bats: "R", stamina: 4, pitchSpeed: 8, offSpeed: 6, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Tommy Boggs", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 5, offSpeed: 6, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Greg Harris", pos: "RP", throws: "R", bats: "S", stamina: 4, pitchSpeed: 7, offSpeed: 6, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "John Butcher", pos: "RP", throws: "R", bats: "R", stamina: 4, pitchSpeed: 5, offSpeed: 5, control: 5, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
  ...
  expos: {
    ...
    lineup: [
      { name: "Tim Raines", pos: "LF", bats: "S", contact: 8, power: 5, bunting: 7, speed: 10, defense: 7, arm: 6,
        splits: { vsLHP: { ab: 145, ba: .296, hr: 3 }, vsRHP: { ab: 477, ba: .309, hr: 5 } } },
      { name: "Andre Dawson", pos: "CF", bats: "R", contact: 7, power: 8, bunting: 3, speed: 7, defense: 10, arm: 10,
        splits: { vsLHP: { ab: 185, ba: .276, hr: 10 }, vsRHP: { ab: 448, ba: .256, hr: 7 } } },
      { name: "Gary Carter", pos: "C", bats: "R", contact: 7, power: 8, bunting: 2, speed: 2, defense: 9, arm: 9,
        splits: { vsLHP: { ab: 196, ba: .296, hr: 7 }, vsRHP: { ab: 400, ba: .294, hr: 20 } } },
      { name: "Al Oliver", pos: "1B", bats: "L", contact: 8, power: 5, bunting: 3, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.279, 12, 408, 122, "L") },
      { name: "Tim Wallach", pos: "3B", bats: "R", contact: 7, power: 6, bunting: 3, speed: 3, defense: 7, arm: 8,
        splits: { vsLHP: { ab: 168, ba: .259, hr: 5 }, vsRHP: { ab: 414, ba: .246, hr: 13 } } },
      { name: "Mike Easler", pos: "RF", bats: "L", contact: 7, power: 5, bunting: 3, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.280, 18, 498, 148, "L") },
      { name: "Doug Flynn", pos: "2B", bats: "R", contact: 5, power: 2, bunting: 6, speed: 4, defense: 7, arm: 6,
        splits: estSplits(.237, 3, 281, 84, "R") },
      { name: "Chris Speier", pos: "SS", bats: "S", contact: 5, power: 3, bunting: 5, speed: 3, defense: 7, arm: 7,
        splits: estSplits(.253, 9, 389, 116, "S") },
    ],
    bench: [
      { name: "Pete Rose", pos: "1B", bats: "S", contact: 8, power: 1, bunting: 8, speed: 3, defense: 4, arm: 4,
        splits: estSplits(.259, 0, 374, 112, "S") },
      { name: "Ricky Adams", pos: "SS/2B", bats: "R", contact: 4, power: 2, bunting: 5, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.231, 2, 108, 32, "R") },
      { name: "Terry Francona", pos: "OF/1B", bats: "L", contact: 6, power: 2, bunting: 5, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.346, 1, 214, 64, "L") },
      { name: "Derrel Thomas", pos: "INF/OF", bats: "S", contact: 5, power: 2, bunting: 5, speed: 5, defense: 6, arm: 5,
        splits: estSplits(.231, 2, 134, 40, "S") },
      { name: "Mike Ramsey", pos: "SS/2B", bats: "S", contact: 4, power: 2, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.216, 1, 98, 28, "S") },
    ],
    rotation: [
      ...
      { name: "David Palmer", pos: "SP", throws: "R", bats: "R", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 6, contact: 3, power: 1, bunting: 5, speed: 3 },
    ],
    bullpen: [
      ...
      { name: "Bill Gullickson", pos: "RP", throws: "R", bats: "R", stamina: 5, pitchSpeed: 6, offSpeed: 7, control: 6, contact: 3, power: 1, bunting: 4, speed: 2 },
    ],
  },
  ...
  pirates: {
    ...
    lineup: [
      { name: "Bill Madlock", pos: "3B", bats: "R", contact: 8, power: 5, bunting: 4, speed: 4, defense: 6, arm: 7,
        splits: { vsLHP: { ab: 122, ba: .344, hr: 4 }, vsRHP: { ab: 421, ba: .247, hr: 6 } } },
      { name: "Jason Thompson", pos: "1B", bats: "L", contact: 6, power: 6, bunting: 3, speed: 2, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 74, ba: .203, hr: 2 }, vsRHP: { ab: 353, ba: .212, hr: 12 } } },
      { name: "Tony Pena", pos: "C", bats: "R", contact: 7, power: 5, bunting: 3, speed: 4, defense: 9, arm: 9,
        splits: { vsLHP: { ab: 168, ba: .293, hr: 6 }, vsRHP: { ab: 378, ba: .286, hr: 9 } } },
      { name: "Lee Lacy", pos: "RF", bats: "R", contact: 7, power: 4, bunting: 5, speed: 6, defense: 6, arm: 6,
        splits: { vsLHP: { ab: 109, ba: .294, hr: 3 }, vsRHP: { ab: 351, ba: .321, hr: 9 } } },
      { name: "Mike Easier", pos: "LF", bats: "L", contact: 7, power: 5, bunting: 3, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.280, 18, 488, 148, "L") },
      { name: "Marvell Wynne", pos: "CF", bats: "L", contact: 5, power: 3, bunting: 6, speed: 7, defense: 7, arm: 6,
        splits: estSplits(.243, 6, 411, 124, "L") },
      { name: "Sammy Khalifa", pos: "SS", bats: "S", contact: 4, power: 2, bunting: 5, speed: 5, defense: 6, arm: 6,
        splits: estSplits(.212, 1, 158, 46, "S") },
      { name: "Johnny Ray", pos: "2B", bats: "S", contact: 7, power: 3, bunting: 6, speed: 5, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 173, ba: .300, hr: 1 }, vsRHP: { ab: 443, ba: .292, hr: 4 } } },
    ],
    bench: [
      { name: "Sixto Lezcano", pos: "OF", bats: "R", contact: 5, power: 4, bunting: 3, speed: 3, defense: 5, arm: 7,
        splits: estSplits(.237, 4, 134, 40, "R") },
      { name: "Kent Tekulve", pos: "SS", bats: "R", contact: 4, power: 1, bunting: 4, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.185, 1, 54, 16, "R") },
      { name: "Jim Morrison", pos: "3B/SS", bats: "R", contact: 5, power: 4, bunting: 4, speed: 3, defense: 5, arm: 6,
        splits: estSplits(.252, 11, 268, 80, "R") },
      { name: "Joe Orsulak", pos: "OF", bats: "L", contact: 6, power: 2, bunting: 5, speed: 6, defense: 6, arm: 5,
        splits: estSplits(.249, 1, 152, 46, "L") },
      { name: "Junior Ortiz", pos: "C", bats: "R", contact: 5, power: 2, bunting: 4, speed: 2, defense: 6, arm: 6,
        splits: estSplits(.241, 2, 108, 32, "R") },
    ],
    rotation: [
      ...
      { name: "Larry McWilliams", pos: "SP", throws: "L", bats: "L", stamina: 7, pitchSpeed: 6, offSpeed: 7, control: 6, contact: 3, power: 1, bunting: 5, speed: 2 },
    ],
    bullpen: [
  ...
  braves: {
    ...
    lineup: [
      { name: "Dale Murphy", pos: "CF", bats: "R", contact: 7, power: 9, bunting: 2, speed: 6, defense: 8, arm: 8,
        splits: { vsLHP: { ab: 183, ba: .295, hr: 9 }, vsRHP: { ab: 524, ba: .299, hr: 27 } } },
      { name: "Bob Horner", pos: "3B", bats: "R", contact: 7, power: 8, bunting: 1, speed: 2, defense: 5, arm: 7,
        splits: { vsLHP: { ab: 148, ba: .243, hr: 6 }, vsRHP: { ab: 267, ba: .292, hr: 18 } } },
      { name: "Chris Chambliss", pos: "1B", bats: "L", contact: 7, power: 5, bunting: 3, speed: 2, defense: 6, arm: 5,
        splits: estSplits(.275, 11, 396, 118, "L") },
      { name: "Claudell Washington", pos: "RF", bats: "L", contact: 6, power: 5, bunting: 4, speed: 7, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 96, ba: .271, hr: 2 }, vsRHP: { ab: 392, ba: .279, hr: 15 } } },
      { name: "Ken Oberkfell", pos: "2B", bats: "L", contact: 6, power: 3, bunting: 6, speed: 4, defense: 6, arm: 6,
        splits: estSplits(.281, 4, 296, 88, "L") },
      { name: "Brad Komminsk", pos: "LF", bats: "R", contact: 5, power: 4, bunting: 4, speed: 6, defense: 5, arm: 6,
        splits: estSplits(.202, 8, 301, 90, "R") },
      { name: "Alex Trevino", pos: "C", bats: "R", contact: 5, power: 3, bunting: 4, speed: 3, defense: 6, arm: 7,
        splits: estSplits(.229, 4, 241, 72, "R") },
      { name: "Rafael Ramirez", pos: "SS", bats: "R", contact: 5, power: 3, bunting: 5, speed: 5, defense: 5, arm: 6,
        splits: { vsLHP: { ab: 167, ba: .261, hr: 1 }, vsRHP: { ab: 399, ba: .273, hr: 1 } } },
    ],
    bench: [
      { name: "Gerald Perry", pos: "1B/OF", bats: "L", contact: 6, power: 3, bunting: 5, speed: 5, defense: 5, arm: 5,
        splits: estSplits(.238, 7, 254, 76, "L") },
      { name: "Larry Owen", pos: "C", bats: "R", contact: 4, power: 2, bunting: 3, speed: 2, defense: 5, arm: 6,
        splits: estSplits(.214, 2, 84, 24, "R") },
      { name: "Milt Thompson", pos: "OF", bats: "L", contact: 5, power: 2, bunting: 5, speed: 7, defense: 6, arm: 5,
        splits: estSplits(.257, 2, 141, 42, "L") },
      { name: "Terry Harper", pos: "OF", bats: "R", contact: 5, power: 4, bunting: 4, speed: 4, defense: 5, arm: 6,
        splits: estSplits(.261, 10, 272, 82, "R") },
      { name: "Craig McMurtry", pos: "SS", bats: "R", contact: 4, power: 1, bunting: 4, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.192, 0, 46, 14, "R") },
    ],
    rotation: [
  ...
  astros: {
    ...
    stadium: "Astrodome",
    lineup: [
      { name: "Jose Cruz", pos: "LF", bats: "L", contact: 8, power: 5, bunting: 5, speed: 6, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 113, ba: .319, hr: 4 }, vsRHP: { ab: 461, ba: .312, hr: 8 } } },
      { name: "Enos Cabell", pos: "1B", bats: "R", contact: 7, power: 4, bunting: 5, speed: 4, defense: 6, arm: 6,
        splits: { vsLHP: { ab: 148, ba: .297, hr: 3 }, vsRHP: { ab: 412, ba: .310, hr: 5 } } },
      { name: "Kevin Bass", pos: "RF", bats: "S", contact: 6, power: 5, bunting: 5, speed: 7, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 134, ba: .328, hr: 6 }, vsRHP: { ab: 347, ba: .252, hr: 10 } } },
      { name: "Terry Puhl", pos: "CF", bats: "L", contact: 7, power: 3, bunting: 5, speed: 7, defense: 8, arm: 7,
        splits: { vsLHP: { ab: 86, ba: .349, hr: 2 }, vsRHP: { ab: 289, ba: .301, hr: 7 } } },
      { name: "Bill Doran", pos: "2B", bats: "S", contact: 6, power: 3, bunting: 6, speed: 7, defense: 7, arm: 5,
        splits: { vsLHP: { ab: 155, ba: .271, hr: 4 }, vsRHP: { ab: 397, ba: .270, hr: 5 } } },
      { name: "Phil Garner", pos: "3B", bats: "R", contact: 6, power: 4, bunting: 5, speed: 5, defense: 6, arm: 6,
        splits: { vsLHP: { ab: 148, ba: .269, hr: 5 }, vsRHP: { ab: 344, ba: .278, hr: 6 } } },
      { name: "Alan Ashby", pos: "C", bats: "S", contact: 5, power: 4, bunting: 3, speed: 2, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 63, ba: .254, hr: 1 }, vsRHP: { ab: 270, ba: .256, hr: 9 } } },
      { name: "Dickie Thon", pos: "SS", bats: "R", contact: 7, power: 4, bunting: 5, speed: 6, defense: 8, arm: 7,
        splits: estSplits(.251, 6, 252, 74, "R") },
    ],
    bench: [
      { name: "Mark Bailey", pos: "C", bats: "S", contact: 4, power: 3, bunting: 4, speed: 2, defense: 6, arm: 6,
        splits: estSplits(.211, 5, 161, 48, "S") },
      { name: "Denny Walling", pos: "1B/3B", bats: "L", contact: 6, power: 4, bunting: 4, speed: 3, defense: 5, arm: 5,
        splits: estSplits(.286, 6, 246, 74, "L") },
      { name: "Craig Reynolds", pos: "SS", bats: "L", contact: 5, power: 2, bunting: 6, speed: 4, defense: 7, arm: 6,
        splits: estSplits(.249, 3, 229, 68, "L") },
      { name: "Frank DiPino", pos: "OF", bats: "L", contact: 4, power: 1, bunting: 4, speed: 3, defense: 4, arm: 5,
        splits: estSplits(.185, 1, 54, 16, "L") },
      { name: "Omar Moreno", pos: "CF", bats: "L", contact: 5, power: 2, bunting: 7, speed: 9, defense: 7, arm: 6,
        splits: estSplits(.241, 2, 269, 80, "L") },
    ],
    rotation: [
      ...
      { name: "Vern Ruhle", pos: "SP", throws: "R", bats: "R", stamina: 7, pitchSpeed: 5, offSpeed: 6, control: 7, contact: 3, power: 1, bunting: 4, speed: 2 },
    ],
    bullpen: [
      { name: "Dave Smith", pos: "CL", throws: "R", bats: "R", stamina: 4, pitchSpeed: 7, offSpeed: 7, control: 8, contact: 2, power: 1, bunting: 3, speed: 2 },
      { name: "Frank DiPino", pos: "RP", throws: "L", bats: "L", stamina: 4, pitchSpeed: 6, offSpeed: 7, control: 6, contact: 2, power: 1, bunting: 3, speed: 2 },
  ...
  giants: {
    ...
    lineup: [
      { name: "Jack Clark", pos: "RF", bats: "R", contact: 7, power: 8, bunting: 2, speed: 4, defense: 6, arm: 7,
        splits: estSplits(.320, 11, 401, 120, "R") },
      { name: "Jeff Leonard", pos: "LF", bats: "R", contact: 6, power: 6, bunting: 3, speed: 5, defense: 6, arm: 7,
        splits: { vsLHP: { ab: 148, ba: .295, hr: 7 }, vsRHP: { ab: 372, ba: .286, hr: 14 } } },
      { name: "Chili Davis", pos: "CF", bats: "S", contact: 7, power: 6, bunting: 3, speed: 5, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 162, ba: .296, hr: 7 }, vsRHP: { ab: 437, ba: .311, hr: 14 } } },
      { name: "Darrell Evans", pos: "1B", bats: "L", contact: 6, power: 8, bunting: 2, speed: 3, defense: 6, arm: 5,
        splits: { vsLHP: { ab: 98, ba: .224, hr: 4 }, vsRHP: { ab: 376, ba: .255, hr: 24 } } },
      { name: "Bob Brenly", pos: "C", bats: "R", contact: 6, power: 6, bunting: 2, speed: 3, defense: 7, arm: 7,
        splits: { vsLHP: { ab: 148, ba: .291, hr: 7 }, vsRHP: { ab: 344, ba: .289, hr: 13 } } },
      { name: "Manny Trillo", pos: "2B", bats: "R", contact: 6, power: 3, bunting: 5, speed: 4, defense: 8, arm: 7,
        splits: estSplits(.254, 4, 399, 118, "R") },
      { name: "Chris Brown", pos: "3B", bats: "R", contact: 7, power: 5, bunting: 4, speed: 4, defense: 6, arm: 7,
        splits: estSplits(.271, 7, 234, 70, "R") },
      { name: "Johnnie LeMaster", pos: "SS", bats: "S", contact: 4, power: 2, bunting: 6, speed: 4, defense: 6, arm: 6,
        splits: estSplits(.210, 3, 281, 84, "S") },
    ],
    bench: [
      { name: "Dan Gladden", pos: "OF", bats: "R", contact: 7, power: 4, bunting: 5, speed: 7, defense: 7, arm: 6,
        splits: estSplits(.351, 4, 188, 56, "R") },
      { name: "Greg Minton", pos: "RP", bats: "R", contact: 3, power: 1, bunting: 4, speed: 2, defense: 4, arm: 5,
        splits: estSplits(.186, 0, 43, 12, "R") },
      { name: "David Green", pos: "OF", bats: "R", contact: 5, power: 4, bunting: 4, speed: 6, defense: 6, arm: 7,
        splits: estSplits(.248, 9, 281, 84, "R") },
      { name: "Brad Wellman", pos: "SS/2B", bats: "R", contact: 4, power: 2, bunting: 5, speed: 4, defense: 6, arm: 5,
        splits: estSplits(.214, 2, 108, 32, "R") },
      { name: "Scot Thompson", pos: "OF", bats: "L", contact: 6, power: 2, bunting: 5, speed: 4, defense: 5, arm: 5,
        splits: estSplits(.254, 2, 134, 40, "L") },
    ],
    rotation: [
      { name: "Atlee Hammaker", pos: "SP", throws: "L", bats: "L", stamina: 7, pitchSpeed: 6, offSpeed: 8, control: 7, contact: 3, power: 1, bunting: 5, speed: 2 },
    ...
    bullpen: [
      ...
      { name: "Jim Barr", pos: "RP", throws: "R", bats: "R", stamina: 5, pitchSpeed: 5, offSpeed: 7, control: 7, contact: 2, power: 1, bunting: 3, speed: 2 },
    ],
  },
...
export const MANAGERS = {
  ...
  // New teams
  bluejays: { name: "Bobby Cox", personality: 4, coach: "Jimy Williams",
    arguesBallsStrikes: 40, arguesSafeOut: 55, protectsPlayers: 65, strategicEjections: 10 },
  indians: { name: "Pat Corrales", personality: 6, coach: "Bobby Bonds",
    arguesBallsStrikes: 55, arguesSafeOut: 65, protectsPlayers: 60, strategicEjections: 15 },
  brewers: { name: "Rene Lachemann", personality: 5, coach: "Larry Haney",
    arguesBallsStrikes: 45, arguesSafeOut: 55, protectsPlayers: 55, strategicEjections: 10 },
  twins: { name: "Billy Gardner", personality: 5, coach: "Tony Oliva",
    arguesBallsStrikes: 45, arguesSafeOut: 55, protectsPlayers: 55, strategicEjections: 10 },
  athletics: { name: "Steve Boros", personality: 4, coach: "Clete Boyer",
    arguesBallsStrikes: 40, arguesSafeOut: 50, protectsPlayers: 60, strategicEjections: 10 },
  angels: { name: "John McNamara", personality: 5, coach: "Bobby Knoop",
    arguesBallsStrikes: 45, arguesSafeOut: 55, protectsPlayers: 60, strategicEjections: 15 },
  whitesox: { name: "Tony LaRussa", personality: 6, coach: "Dave Duncan",
    arguesBallsStrikes: 60, arguesSafeOut: 70, protectsPlayers: 75, strategicEjections: 25 },
  mariners: { name: "Del Crandall", personality: 4, coach: "Vada Pinson",
    arguesBallsStrikes: 35, arguesSafeOut: 45, protectsPlayers: 50, strategicEjections: 10 },
  rangers: { name: "Doug Rader", personality: 7, coach: "Art Howe",
    arguesBallsStrikes: 65, arguesSafeOut: 75, protectsPlayers: 70, strategicEjections: 20 },
  expos: { name: "Bill Virdon", personality: 4, coach: "Ron Hansen",
    arguesBallsStrikes: 35, arguesSafeOut: 50, protectsPlayers: 55, strategicEjections: 10 },
  cardinals: { name: "Whitey Herzog", personality: 8, coach: "Mike Roarke",
    arguesBallsStrikes: 75, arguesSafeOut: 85, protectsPlayers: 80, strategicEjections: 35 },
  pirates: { name: "Chuck Tanner", personality: 6, coach: "Bob Skinner",
    arguesBallsStrikes: 55, arguesSafeOut: 65, protectsPlayers: 70, strategicEjections: 20 },
  braves: { name: "Joe Torre", personality: 5, coach: "Rube Walker",
    arguesBallsStrikes: 50, arguesSafeOut: 60, protectsPlayers: 65, strategicEjections: 15 },
  astros: { name: "Bob Lillis", personality: 4, coach: "Denis Menke",
    arguesBallsStrikes: 35, arguesSafeOut: 50, protectsPlayers: 55, strategicEjections: 10 },
  giants: { name: "Frank Robinson", personality: 8, coach: "Jim Davenport",
    arguesBallsStrikes: 70, arguesSafeOut: 80, protectsPlayers: 85, strategicEjections: 30 },
};