...
// 40% game call (Messer), 25% analysis (White), 20% tradition, 10% Scooter, 4% birthdays, 1% distraction

const POOLS = {
  gameCall: {
    weight: 40,
    lines: [
      // Frank Messer: professional, efficient, keeps the broadcast moving
      "\"One away.\"",
      "\"Runner on first.\"",
      "\"Nicely done.\"",
      "\"Good piece of hitting.\"",
      "\"A sharp single to right field.\"",
      "\"Deep to left field — way back — it is gone! A home run.\"",
      "\"The Yankees lead.\"",
      "\"Two down now.\"",
      "\"Here's the 3-2 pitch...\"",
      "\"Ground ball to short — over to first — in time.\"",
      "\"Line drive — base hit.\"",
      "\"Popped up — infield fly rule is in effect.\"",
      "\"Strike three called — he got him looking.\"",
      "\"And the inning is over.\"",
      "\"A well-played game so far.\"",
      "\"The pitcher is really dealing tonight.\"",
      "\"He's been outstanding through six innings.\"",
      "\"The Yankees go down in order.\"",
      "\"A long fly ball — the outfielder drifts back — makes the catch.\"",
      "\"The runner tags and scores — a sacrifice fly.\"",
      "\"And that'll be a double down the line.\"",
      "\"Three up, three down.\"",
      "\"The Yankees have something going here.\"",
      "\"A base hit drives in a run.\"",
    ],
  },
  analysis: {
    weight: 25,
    lines: [
      // Bill White: smartest analyst in the booth, always talking pitch sequences and approach
      "\"The pitcher got ahead early — that's the key.\"",
      "\"Everything starts with strike one. When you're behind, you're guessing.\"",
      "\"Excellent location — right on the corner.\"",
      "\"Good fastball command. He can put it wherever he wants tonight.\"",
      ...
      "\"Good at-bat. Made the pitcher work.\"",
      "\"He's seeing the ball well tonight. Very dangerous.\"",
      "\"The pitcher is changing speeds effectively.\"",
      "\"You don't want to fall behind a hitter like this.\"",
      "\"He's got a lot of movement on that fastball.\"",
      "\"The breaking ball isn't there tonight — he's relying on the fastball.\"",
      "\"Smart pitching. Kept the ball down in the zone.\"",
      "\"He's a tough out. Doesn't give away at-bats.\"",
      "\"The approach has to be: don't let him beat you.\"",
      "\"That's just good fundamental baseball.\"",
    ],
  },
  tradition: {
    weight: 20,
    lines: [
      // Yankees identity: winning is assumed, expectations are high
      ...
      "\"A veteran ballclub. They know what it takes.\"",
      "\"The crowd here at Yankee Stadium expects a winner.\"",
      ...
      "\"This franchise doesn't rebuild. They reload.\"",
      "\"The Yankees are always in the conversation.\"",
      ...
      // Player-specific: Mattingly
      "\"Sweet swing. Sweetest swing in the American League.\"",
      "\"One of the best young hitters in baseball — Don Mattingly.\"",
      "\"He rarely gives away an at-bat. That's Donnie Baseball.\"",
      "\"Beautiful stroke. Just a beautiful stroke.\"",
      "\"A line-drive hitter. Doesn't try to lift the ball — just barrels it up.\"",
      "\"Donnie Baseball delivers again. He's something special.\"",
      // Player-specific: Winfield
      "\"A tremendous athlete. Dave Winfield could have played any sport.\"",
      "\"Power to all fields — that's what makes Winfield so dangerous.\"",
      "\"Strong throwing arm. You don't run on Dave Winfield.\"",
      "\"One of the game's premier players, no question.\"",
      "\"Dangerous every trip to the plate. The pitcher knows it.\"",
      // Monument Park & lore
  ...
  scooter: {
    weight: 10,
    lines: [
      // Phil Rizzuto: wandering, distracted, lovable uncle energy
      "\"Holy cow!\"",
      "\"Would ya believe it?\"",
      "\"I tell ya.\"",
      "\"What a ballgame.\"",
      "\"Boy oh boy.\"",
      "\"That reminds me — I gotta call my brother.\"",
      "\"Did you see that fellow behind home plate? Terrific hat.\"",
      ...
      "\"Frank, did you see that? I missed it.\"",
      "\"Bill, help me out here — what just happened?\"",
  ...
  birthdays: {
    weight: 4,
    lines: [
      // Rizzuto's famous birthday announcements and stand-scanning
  ...
  distraction: {
    weight: 1,
    lines: [
      // Complete Scooter distraction — the game is barely happening
