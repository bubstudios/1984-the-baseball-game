...
export const OLYMPICS_1984_BANNER = {
  ...
  popups: [
    // ── WINDOW 01: MARY LOU RETTON ──
    {
      ...
      whatItWas: 'A pint-sized, sparkplug gymnast from West Virginia with an ear-to-ear grin and explosive power — and, that summer, the most beloved athlete in America.',
      howChanged: 'Needing a perfect score on her final vault to win the all-around gold, she nailed it — a 10.0 — and became an instant national sweetheart.',
      craze: 'Her face was suddenly everywhere — cereal boxes, magazine covers, talk shows. She made gymnastics a mainstream American obsession overnight.',
      howAged: 'One of the enduring images of the entire decade; "perfect 10" became cultural shorthand. 🤸‍♀️',
    ...
    // ── WINDOW 02: CARL LEWIS ──
    {
      ...
      whatItWas: 'A sprinter and long jumper of rare, generational talent — fast, powerful, and chasing a piece of history.',
      howChanged: 'He won four gold medals (100m, 200m, long jump, and the 4x100 relay), deliberately echoing the legendary four-gold feat of Jesse Owens nearly fifty years earlier.',
      craze: 'A track-and-field superstar whose dominance defined the L.A. Games and launched one of the great Olympic careers.',
      howAged: 'A legend; the Owens echo cemented him in Olympic history. 🏃',
    ...
    // ── WINDOW 04: GREG LOUGANIS ──
    {
      ...
      howAged: 'Still regarded as the finest diver in history. 🤿',
    ...
    // ── WINDOW 16: THE BOXING TEAM ──
    {
      ...
      howAged: 'Looked back on as a stacked, star-making boxing tournament. 🥊',
