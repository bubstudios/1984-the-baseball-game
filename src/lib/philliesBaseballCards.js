...
export const PHILLIES_ROSTER = [
  ...
  { id: 2, name: 'Steve Carlton', position: 'SP', number: 32, ba: '-', hr: '-', rbi: '-', era: '3.58', role: 'Ace Lefty', rarity: 'rare' },
  ...
  { id: 8, name: 'Ivan DeJesus', position: 'SS', number: 6, ba: '.257', hr: 0, rbi: 35, era: '-', role: 'Shortstop', rarity: 'common' },
  { id: 9, name: 'Jeff Stone', position: 'LF', number: 25, ba: '.362', hr: 1, rbi: 18, era: '-', role: 'Left Field/Speedster', rarity: 'uncommon' },
  { id: 10, name: 'John Denny', position: 'SP', number: 23, ba: '-', hr: '-', rbi: '-', era: '4.64', role: 'Starting Pitcher', rarity: 'uncommon' },
  { id: 11, name: 'Kevin Gross', position: 'SP', number: 33, ba: '-', hr: '-', rbi: '-', era: '4.12', role: 'Starting Pitcher', rarity: 'common' },
  { id: 12, name: 'Charles Hudson', position: 'SP', number: 45, ba: '-', hr: '-', rbi: '-', era: '4.04', role: 'Starting Pitcher', rarity: 'common' },
  { id: 13, name: 'Al Holland', position: 'CL', number: 47, ba: '-', hr: '-', rbi: '-', era: '5.24', role: 'Closer/Mr. T', rarity: 'uncommon' },
  { id: 14, name: 'Kent Tekulve', position: 'RP', number: 27, ba: '-', hr: '-', rbi: '-', era: '5.25', role: 'Submarine Reliever', rarity: 'uncommon' },
  { id: 15, name: 'Larry Andersen', position: 'RP', number: 37, ba: '-', hr: '-', rbi: '-', era: '2.38', role: 'Relief Pitcher', rarity: 'common' },
  { id: 16, name: 'Don Carman', position: 'RP', number: 44, ba: '-', hr: '-', rbi: '-', era: '4.56', role: 'Relief Pitcher', rarity: 'common' },
  { id: 17, name: 'Len Matuszek', position: '1B', number: 17, ba: '.268', hr: 12, rbi: 43, era: '-', role: 'Backup First Base', rarity: 'common' },
  { id: 18, name: 'Greg Gross', position: 'OF', number: 3, ba: '.274', hr: 1, rbi: 14, era: '-', role: 'Pinch Hitter', rarity: 'common' },
  { id: 19, name: 'Derrel Thomas', position: 'INF/OF', number: 2, ba: '.239', hr: 3, rbi: 23, era: '-', role: 'Utility Player', rarity: 'common' },
  { id: 20, name: 'Bo Diaz', position: 'C', number: 15, ba: '.240', hr: 5, rbi: 26, era: '-', role: 'Backup Catcher', rarity: 'common' },
];
...
export function addCollectedPhilliesCard(cardId) {
  ...
  if (count === 10 && !localStorage.getItem('ach_phi_card_collector')) {
    localStorage.setItem('ach_phi_card_collector', Date.now());
    unlocked.push('phi_card_collector');
  }
  if (count === 20 && !localStorage.getItem('ach_phi_complete_roster')) {
