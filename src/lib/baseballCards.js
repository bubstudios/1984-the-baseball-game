...
export const ALL_ROSTERS = {
  ...
  reds: [
    ...
    { id: 5,  name: 'Eddie Milner',     position: 'CF',   number: 21, ba: '.253', hr: 8,  rbi: 46,  era: '-',    role: 'Center Field/Speed',   rarity: 'uncommon' },
    { id: 23, name: 'Cesar Cedeno',    position: 'OF',   number: 11, ba: '.276', hr: 10, rbi: 58,  era: '-',    role: 'Bench Outfielder',     rarity: 'uncommon' },
  ...
  royals: [
    ...
    { id: 15, name: 'Mike Jones',      position: 'RP',   number: 36, ba: '-',    hr: '-', rbi: '-', era: '4.24', role: 'Relief Pitcher',       rarity: 'common'   },
    { id: 16, name: 'Joe Beckwith',    position: 'RP',   number: 47, ba: '-',    hr: '-', rbi: '-', era: '3.58', role: 'Relief Pitcher',       rarity: 'common'   },
    { id: 17, name: 'Larry Gura',      position: 'RP',   number: 37, ba: '-',    hr: '-', rbi: '-', era: '5.18', role: 'Relief/Veteran',       rarity: 'uncommon' },
    { id: 18, name: 'Mark Huismann',   position: 'RP',   number: 30, ba: '-',    hr: '-', rbi: '-', era: '4.20', role: 'Relief Pitcher',       rarity: 'common'   },
    { id: 19, name: 'Paul Splittorff', position: 'RP',   number: 25, ba: '-',    hr: '-', rbi: '-', era: '7.71', role: 'Relief/Legend',         rarity: 'uncommon' },
    { id: 20, name: 'Dane Iorg',       position: '1B',   number: 15, ba: '.276', hr: 4,  rbi: 26,  era: '-',    role: 'Bench/Utility',        rarity: 'common'   },
    { id: 21, name: 'Buddy Biancalana',position: 'SS',   number: 8,  ba: '.188', hr: 2,  rbi: 10,  era: '-',    role: 'Backup Shortstop',     rarity: 'common'   },
    { id: 22, name: 'John Wathan',     position: 'C',    number: 14, ba: '.249', hr: 4,  rbi: 22,  era: '-',    role: 'Backup Catcher',       rarity: 'common'   },
    { id: 23, name: 'Greg Pryor',      position: 'INF',  number: 12, ba: '.231', hr: 2,  rbi: 14,  era: '-',    role: 'Utility Infielder',    rarity: 'common'   },
    { id: 24, name: 'UL Washington',   position: 'SS',   number: 16, ba: '.224', hr: 1,  rbi: 10,  era: '-',    role: 'Bench Infielder',      rarity: 'common'   },
    { id: 25, name: 'Don Slaught',     position: 'C',   number: 13,  ba: '.264', hr: 4,  rbi: 42,  era: '-',    role: 'Backup Catcher',       rarity: 'common'   },
  ],
  ...
  dodgers: [
    ...
    { id: 18, name: 'Rick Honeycutt',  position: 'SP',   number: 25, ba: '-',    hr: '-', rbi: '-', era: '4.53', role: 'Starting Pitcher',     rarity: 'common'   },
    { id: 19, name: 'Jerry Reuss',     position: 'SP',   number: 48, ba: '-',    hr: '-', rbi: '-', era: '4.49', role: 'Starting Pitcher',     rarity: 'common'   },
    { id: 20, name: 'Bill Russell',    position: 'SS',   number: 18, ba: '.238', hr: 1,  rbi: 17,  era: '-',    role: 'Veteran Utility',      rarity: 'common'   },
    { id: 21, name: 'Candy Maldonado', position: 'OF',   number: 17, ba: '.248', hr: 6,  rbi: 24,  era: '-',    role: 'Bench Outfielder',     rarity: 'common'   },
    { id: 22, name: 'Bob Bailor',      position: 'INF',  number: 7,  ba: '.231', hr: 2,  rbi: 11,  era: '-',    role: 'Utility Infielder',    rarity: 'common'   },
    { id: 23, name: 'Steve Yeager',    position: 'C',    number: 7,  ba: '.214', hr: 4,  rbi: 19,  era: '-',    role: 'Backup Catcher',       rarity: 'common'   },
    { id: 24, name: 'R.J. Reynolds',   position: 'OF',   number: 16, ba: '.241', hr: 3,  rbi: 18,  era: '-',    role: 'Bench Outfielder',     rarity: 'common'   },
    { id: 25, name: 'German Rivera',   position: 'INF',  number: 19, ba: '.248', hr: 2,  rbi: 15,  era: '-',    role: 'Utility Infielder',    rarity: 'common'   },
  ],
