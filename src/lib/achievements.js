...
export const ACHIEVEMENTS = [
  ...
  { id: 'weekend_warrior', name: 'Weekend Warrior', desc: 'Play on 5 different weekends', icon: '📅', category: 'community', threshold: 5 },
  { id: 'daily_grind', name: 'Daily Grind', desc: 'Play on 14 consecutive days', icon: '🔄', category: 'community', threshold: 14 },
  { id: 'month_of_mayhem', name: 'Month of Mayhem', desc: 'Play on 30 different days', icon: '🗓️', category: 'community', threshold: 30 },
  { id: 'season_ticket', name: 'Season Ticket', desc: 'Play on 60 different days', icon: '🎫', category: 'community', threshold: 60 },
  { id: 'full_season', name: 'Full Season', desc: 'Play on 90 different days', icon: '📆', category: 'community', threshold: 90 },
  { id: 'calendar_year', name: 'Calendar Year', desc: 'Play on 365 different days', icon: '🎊', category: 'community', threshold: 365 },
  { id: 'power_hour', name: 'Power Hour', desc: 'Play 5 games in one hour', icon: '⚡', category: 'community' },
  { id: 'marathon_man', name: 'Marathon Man', desc: 'Play 20 games in one session', icon: '🏃‍♂️', category: 'community' },
  { id: 'ultra_marathon', name: 'Ultra Marathon', desc: 'Play 50 games in one session', icon: '🦸', category: 'community' },
  ...
  { id: 'road_dominance', name: 'Road Dominance', desc: 'Win 25 road games', icon: '🚌', category: 'milestone', threshold: 25 },
  ...
  { id: 'time_invested_50h', name: 'Baseball Lifers', desc: 'Play for 50 hours', icon: '🏆', category: 'milestone', threshold: 3000 },
