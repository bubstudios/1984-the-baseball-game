...
export const ACHIEVEMENTS = [
  ...
  // ── ARCADE & VIDEOGAMES ──
  { id: 'arcade_enthusiast', name: 'Arcade Enthusiast', desc: 'View 5 arcade/videogame popups', icon: '🕹️', category: 'community' },
  ...
  // ── 1984 LA OLYMPICS ──
  { id: 'olympic_fan', name: 'Olympic Fan', desc: 'View 5 Olympic exhibits', icon: '🏅', category: 'community' },
  ...
  // ── NASA & SPACE ──
  { id: 'space_explorer', name: 'Space Explorer', desc: 'View 5 NASA space exhibits', icon: '🚀', category: 'community' },
  ...
  // ── THINGS THAT SCREAM 1984 ──
  { id: 'scream_1984_fan', name: '1984 Fan', desc: 'View 5 Things That Scream 1984 exhibits', icon: '✨', category: 'community' },
