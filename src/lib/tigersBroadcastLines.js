...
// 35% game action, 20% team praise, 15% player obs, 15% weather, 10% crowd, 4% folksy, 1% signature
...
const POOLS = {
  gameAction: {
    ...
    lines: [
      "\"Strike three called.\"",
      "\"Got him looking.\"",
      "\"He never offered at that one.\"",
      "\"Caught him on the corner.\"",
      "\"Back to the dugout he goes.\"",
      ...
      "\"A towering fly ball — carrying toward the wall...\"",
      "\"The pitcher delivers — and it's in there for a strike.\"",
  ...
  players: {
    weight: 15,
    lines: [
      "\"Alan Trammell — steady as they come. A fine shortstop.\"",
      "\"Very dependable. Trammell is one of the game's best.\"",
      "\"Lou Whitaker — smooth in the field, excellent all-around player.\"",
      "\"A key contributor — Whitaker does a little bit of everything well.\"",
      "\"Kirk Gibson plays hard every day. A fiery competitor.\"",
      "\"Gibson brings energy to this club. Dangerous hitter, too.\"",
      "\"Jack Morris is a workhorse. Competitive pitcher — he'll challenge hitters.\"",
      "\"Morris is one of the league's best. You want the ball in his hands in a big game.\"",
      "\"Lance Parrish behind the plate — a rock back there.\"",
      "\"Chet Lemon in center field — covers a lot of ground.\"",
      "\"Darrell Evans has been a tremendous addition to this lineup.\"",
  ...
  atmosphere: {
    ...
    lines: [
      ...
      "\"The flags are moving gently in the breeze.\"",
      "\"The sun is shining brightly over The Corner.\"",
      "\"Another beautiful Michigan afternoon.\"",
      "\"Good day for baseball.\"",
      "\"A pleasant breeze coming in from the outfield.\"",
      "\"The sky is clear — a perfect evening at the ballpark.\"",
  ...
  crowd: {
    ...
    lines: [
      ...
      "\"Listen to that crowd. They're into this ballgame.\"",
      "\"The folks here enjoyed that one.\"",
      "\"The crowd came to life on that play.\"",
      "\"A nice ovation for a job well done.\"",
  ...
  folksy: {
    ...
    lines: [
      ...
      "\"A fine crowd here today at Tiger Stadium.\"",
  ...
  signature: {
    ...
    lines: [
      ...
      "\"The folks are enjoying this one.\"",
      "\"That ball had a passport on it.\"",
