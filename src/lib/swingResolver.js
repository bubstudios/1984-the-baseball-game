...
export function resolveSwing(state, swingType, pitch) {
  ...
  let contactChance = 0.39 + contactRating * 0.36;
  ...
  let hitChance = 0.15 + (contactRating + contactWx / 10) * 0.21;
  ...
  if (Math.random() < hitChance) {
    ...
    if (hr2 < effPwr * 0.19 * hrMod * ballparkHRMod) {
    ...
    } else if (adjBatter.speed >= 4 && hr2 < (effPwr * 0.19 + sf2 * 0.035) * doubleMod) {
    ...
    } else if (hr2 < effPwr * 0.45 * doubleMod) {
